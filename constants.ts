...
import { User, Post, Story, Reel, LocationData, Event, Group, Song, Album, Podcast, Episode, Brand, Reaction, Conversation, Message } from './types';
...
export const INITIAL_CONVERSATIONS: Conversation[] = [
    { id: 1, participants: [1, 2], lastMessage: "Awesome! See you there.", lastMessageTimestamp: Date.now() - 3600000, unreadCount: 2 },
    { id: 2, participants: [1, 3], lastMessage: "Let's catch up tomorrow!", lastMessageTimestamp: Date.now() - 86400000, unreadCount: 0 },
    { id: 3, participants: [1, 4], lastMessage: "Can you send me the file?", lastMessageTimestamp: Date.now() - 172800000, unreadCount: 1 },
    { id: 4, participants: [1, 5], lastMessage: "Happy Birthday! 🎉", lastMessageTimestamp: Date.now() - 259200000, unreadCount: 0 },
    { id: 5, participants: [1, 6], lastMessage: "Yeah, that new update is sick.", lastMessageTimestamp: Date.now() - 604800000, unreadCount: 0 },
];

export const INITIAL_MESSAGES: Message[] = [
    // Convo 1
    { id: 1, conversationId: 1, senderId: 2, text: "Hey Sarah! Are you going to the tech meetup next week?", timestamp: Date.now() - 4000000 },
    { id: 2, conversationId: 1, senderId: 1, text: "Hey David! Absolutely, I wouldn't miss it. You?", timestamp: Date.now() - 3900000 },
    { id: 3, conversationId: 1, senderId: 2, text: "For sure! I'm excited for the AI talk.", timestamp: Date.now() - 3800000 },
    { id: 4, conversationId: 1, senderId: 2, text: "Awesome! See you there.", timestamp: Date.now() - 3600000 },
    // Convo 2
    { id: 5, conversationId: 2, senderId: 3, text: "Let's catch up tomorrow!", timestamp: Date.now() - 86400000 },
    // Convo 3
    { id: 6, conversationId: 3, senderId: 4, text: "Can you send me the file?", timestamp: Date.now() - 172800000 },
    // Convo 4
    { id: 7, conversationId: 4, senderId: 5, text: "Happy Birthday! 🎉", timestamp: Date.now() - 259200000 },
];
