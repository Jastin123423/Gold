...
import { User, Post as PostType, ReactionType, Reel } from '../types';
...
export const UserProfile: React.FC<UserProfileProps> = ({ user, currentUser, users, posts, reels = [], onProfileClick, onFollow, onReact, onComment, onShare, onMessage, onCreatePost, onUpdateProfileImage, onUpdateCoverImage, onUpdateUserDetails, onDeletePost, onEditPost, getCommentAuthor, onViewImage, onCreateEventClick, onOpenComments, onVideoClick, onNavigate, onVerifyUser, onRestrictUser, onDeleteUser, onMakeModerator }) => {
    ...
    // Strict Admin Check: Must be logged in AND have 'admin' role
                    ...
                    <div className="flex-1 min-w-0">
                        {isCurrentUser && (
                            <div className="bg-[#242526] rounded-xl p-4 mb-4 border border-[#3E4042] shadow-sm animate-fade-in">
                                ...
                                <p className="text-[#B0B3B8] text-xs bg-[#3A3B3C] px-2 py-1 rounded border border-[#3E4042] inline-block mb-4">Private to you</p>
                    ...
                    <div className="px-4 pb-0">
                        <div className="flex flex-col md:flex-row items-center md:items-end -mt-[84px] md:-mt-[30px] relative z-10 mb-4">
                            ...
                            <div className="flex flex-col sm:flex-row items-center gap-2 mt-4 md:mt-0 md:mb-6">
                                {isCurrentUser ? (
                                    <>
                                        <button onClick={() => onNavigate('messages')} className="bg-[#1877F2] text-white px-4 py-2 rounded-md font-semibold flex items-center gap-2 hover:bg-[#166FE5] transition-colors">
                                            <i className="fab fa-facebook-messenger"></i><span>Messages</span>
                                        </button>
